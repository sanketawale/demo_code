...
function getModalHtmlElement() {
    ...
    var htmlString = '<!-- Modal -->'
        + '<div class="modal fade" id="editWishlistProductModal" style="z-index: 9999;" tabindex="-1" role="dialog">'
...
module.exports = {
    ...
    addToCartFromWishlist: function () {
        $('body').on('click', '.add-to-cart', function () {
            ...
            pidsQty = parseInt($(this).parents('.product_details').find('.product_Desc').find('.quantity.custom-select').val(), 10);
