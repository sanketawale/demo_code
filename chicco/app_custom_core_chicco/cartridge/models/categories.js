...
function categoryToObject(category) {
    ...
    var result = {
        ...
        id: category.ID,
        freeMaternityKitEnable: !empty(category.custom.freeMaternityEnabled) && category.custom.freeMaternityEnabled === true ? productCustomHelper.freeMaternityKitEnabled() : false,
        freeMaternityKitEligible: freeMaternityKitHelper.customerEligibleForFreeKit()
    };
